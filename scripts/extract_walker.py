...
SOURCE = Path("/Users/Manasi/Downloads/ChatGPT Image Jul 13, 2026, 10_23_51 PM.png")
NAME = "walker"
FRAME_WIDTH = 180
FRAME_HEIGHT = 300
TARGET_BOTTOM = 282
...
if not SOURCE.exists():
    raise SystemExit(f"Missing walker spritesheet: {SOURCE}")
...
if any(box is None for box in cell_bounds):
    raise SystemExit("At least one walker spritesheet frame is empty.")
...
for index, cell in enumerate(cells):
    ...
    dx = round(TARGET_ANCHOR_X - foot_anchor_x(frame, box))
